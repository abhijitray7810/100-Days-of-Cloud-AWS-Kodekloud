...
Name the bucket devops-s3-1010.
Ensure the bucket is private.
4) Create an IAM Policy and Role:

Create an IAM policy allowing s3:PutObject, s3:ListBucket and s3:GetObject access to devops-s3-1010.
Create an IAM role named devops-role.
Attach the policy to the IAM role.
Attach this role to the devops-ec2 instance.
5) Test the Access:

SSH into the EC2 instance and try to upload a file to devops-s3-1010 bucket using following command:
aws s3 cp <your-file> s3://devops-s3-1010/

Now run following command to list the upload file:
aws s3 ls s3://devops-s3-1010/


Use below given AWS Credentials: (You can run the showcreds command on aws-client host to retrieve these credentials)

Console URL	https://216129179285.signin.aws.amazon.com/console?region=us-east-1
Username	kk_labs_user_812915
Password	m@xk!tDqj6Me
Start Time	Sun Jan 18 14:27:40 UTC 2026
End Time	Sun Jan 18 15:27:40 UTC 2026
